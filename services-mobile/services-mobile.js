...
nextButton2leg.addEventListener('click',()=>{
  ...
  changeble1.innerHTML='10․ Օպերացիոն համակարգ (պլատֆորմ)'
  changeble3.innerHTML='11․ Լեզուների քանակը'
  changeble4.innerHTML='12․ Հավելվածի նպատակը'
  changeble6.innerHTML='13․ Նախնտրելի դիզայնի տարբերակ (Չունենալու դեպքում<br> կարող եք պատվիրել)'
// }
})
